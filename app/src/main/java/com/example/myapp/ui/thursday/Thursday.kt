...
class Thursday : Fragment() {
    ...
    fun displayStuff()
    {
        ...
        db.child("thursday").child("breakfast").get().addOnSuccessListener {
            if(it.exists())
            {
        ...
        db.child("thursday").child("lunch").get().addOnSuccessListener {
            if(it.exists())
            {
                val item1 = it.child("item_1").value
                val item2 = it.child("item_2").value
        ...
        db.child("thursday").child("dinner").get().addOnSuccessListener {
            if(it.exists())
            {
                val item1 = it.child("item_1").value
                val item2 = it.child("item_2").value
