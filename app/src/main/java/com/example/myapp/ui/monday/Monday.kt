...
class Monday : Fragment() {
    ...
    fun displayStuff()
    {
        ...
        db.child("monday").child("breakfast").get().addOnSuccessListener {
            if(it.exists())
            {
        ...
        db.child("monday").child("lunch").get().addOnSuccessListener {
            if(it.exists())
            {
                val item1 = it.child("item_1").value
                val item2 = it.child("item_2").value
        ...
        db.child("monday").child("dinner").get().addOnSuccessListener {
            if(it.exists())
            {
                val item1 = it.child("item_1").value
                val item2 = it.child("item_2").value
